...
// Portions adapted from llama.cpp / ggml (https://github.com/ggml-org/llama.cpp) and the
// YaRN reference implementation (https://github.com/jquesnelle/yarn), both MIT licensed.
