...
//!
//! `KVCacheOps` trait은 `KVCache` (F32/F16/Q4_0 + eviction)와 `QuantizedRecentWindowCache`
...
//!
//! `KVLayout`, `QuantWindowRawBuffers`는 `KVCacheOps` method signature에서 사용되므로
//! 함께 위치한다.
...
pub struct QuantWindowRawBuffers<'a> {
