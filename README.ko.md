...
플러그인 확장 표면을 갖췄습니다. 주된 목표는 쉽게 확장하고 유연하게 설정하며 엔진 코어를
건드리지 않고 기능을 간단히 더하는 것입니다.
...
여기서는 **StreamingLLM** 플러그인을 사용해서 sliding window 방식으로 KV cache가 가득 차는 것을
막았습니다.
...
건드리지 않습니다. 이 확장 표면이 Argus를 고를 이유입니다.
